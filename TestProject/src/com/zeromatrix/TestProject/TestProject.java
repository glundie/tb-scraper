...
public class TestProject {
	...
	boolean sendSN(){
        ...
        if(digit1.isEnabled()) digit1.sendKeys("",Keys.TAB);
        if(digit2.isEnabled()) digit2.sendKeys("",Keys.TAB);
        if(digit3.isEnabled()) digit3.sendKeys("",Keys.TAB);
        if(digit4.isEnabled()) digit4.sendKeys("",Keys.TAB);
        if(digit5.isEnabled()) digit5.sendKeys("",Keys.TAB);
        if(digit6.isEnabled()) digit6.sendKeys("",Keys.TAB);
        return true;
	}
